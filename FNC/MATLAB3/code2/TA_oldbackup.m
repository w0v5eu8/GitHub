...
% average of days / ob / os / slope / slope 
    ...
    LB = [  3;  55;  19;  1.01;  0.09];
    UB = [ 12;  85;  40;  1.99;  0.99];    

numpa_RSI=5; %rng('shuffle')
...
% lt st nh nl equb eulb
    ...
    LB = [ 19;   4;  101;   80;  2.9;  2.9];
    UB = [ 35;  12;  120;   99;   15;   15];

numpa_RC=6; %rng('shuffle')
...
% pK pK-pD pK pD-pK
    ...
    LB = [  15;   1;   50;   1;    5;  1.5;  1.1];
    UB = [  50;   1;   90;   1;   16;    7;    5];

numpa_SS=7; %rng('shuffle')
...
% % % hold off
    ...
    LB = [  4;  90;  90;    5;    5;   1;   3;   1;   3];
    UB = [ 30; 110; 110;   20;   20;   3;   7;   3;   7];

numpa_MA=9; %rng('shuffle')
...
%% PL
    ...
    LB = [  6;   4;   4;    8;    8;   1;   6;   1;  6;   4;   0]; % 50;  30];
    UB = [ 16;  16;  16;   20;   20;   5;   9;   5;  9;  21;   5]; % 70;  50];

numpa_PL=11; %rng('shuffle')
...
%% MFI
    ...
    LB = [  3;  51;  10;    5;    5;   1;   3;   1;   3];
    UB = [ 21;  90;  49;   20;   20;   3;   7;   3;   7];

numpa_MFI=9; %rng('shuffle')
...
%% CCI
    ...
    LB = [   6;   6;     0;   30;  -30;    5;    5;    1;    3;    1;    3];
    UB = [  22;  22;  0.05;   50;    0;   20;   20;    3;    7;    3;    7];

numpa_CCI=11; %rng('shuffle')
...
%% WR
    ...
    LB = [   9;  -80;   3;  -20;    3;    5;    5;   1;   3;   1;   3];
    UB = [  16;  -60;  15;   -0;   15;   20;   20;   3;   7;   3;   7];

numpa_WR=13; %rng('shuffle')
...
%% DMI
    ...
    LB = [   5;   5;   1;   3;   1;   1;   3;   1];
    UB = [  20;  20;   3;   7;   1;   3;   7;   1];

numpa_DMI=8; %rng('shuffle')
