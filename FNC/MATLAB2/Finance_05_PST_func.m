function [out_arg1, out_arg2] = Finance_05_PST_func(T,P,c)
%{
close all;
clear all;
clc;
...
[ymax,xmax,ymin,xmin] = Finance_05_PST_func_extrema(c);
...
if size(sp,1) == 1
    ...
    temp=sp(:,2);
    [ymax,xmax,ymin,xmin] = Finance_05_PST_func_extrema(temp);
