function stocks = FNC_Func_yahoo(start_date, end_date, varargin)
...
for i = 1:length(tickers)
    ...
    url = sprintf(['https://query1.finance.yahoo.com/v7/finance/download/', ...
        '%s?period1=%d&period2=%d&interval=%s&events=%s'], ...
    ...
    % [KHH]
    %
    referer_str=sprintf('https://finance.yahoo.com/quote/%s/history?p=%s',tickers{i},tickers{i});
    options = weboptions('RequestMethod','get','Timeout',Inf, ...
        'HeaderFields', {'Referer' referer_str},...
        'HeaderFields', {'Upgrade-Insecure-Requests' '1'},...
        'HeaderFields', {'User-Agent' 'Mozilla/5.0 (Linux; Android 6.0; Nexus 5 Build/MRA58N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.129 Mobile Safari/537.36'});
    url = sprintf('https://query1.finance.yahoo.com/v7/finance/download/%s',tickers{i});
    ...
    if status
        % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
        %Secci?n modificada de la funci?n original
        ...
        % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
        %Esta secci?n comentada es la que se sustituy? por la secci?n anterior
